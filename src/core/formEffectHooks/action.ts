...
export const onSubmitEffects = () => {
    ...
    onFormSubmitStart(() => {
        console.log("onFormSubmitStart");
    });
    onFormSubmitEnd(() => {
        console.log("onFormSubmitEnd");
    });
    onFormSubmitSuccess(() => {
        console.log("onFormSubmitSuccess");
    });
    onFormSubmitValidateStart(() => {
        console.log("onFormSubmitValidateStart");
    });
    onFormSubmitValidateEnd(() => {
        console.log("onFormSubmitValidateEnd");
    });
    onFormSubmitValidateSuccess(() => {
        console.log('onFormSubmitValidateSuccess');
    });
    onFormSubmitFailed(() => {
        console.log('onFormSubmitFailed');
    });
    onFormSubmitValidateFailed(() => {
        console.log('onFormSubmitValidateFailed');
    });
};
