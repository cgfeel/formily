      ...
      footer={
        <div>
          <p>
            ...
            ，第一个参数是事件名，第二个参数是要传递的 <code>payload</code>。 在 <code>Form</code>{" "}
            和 <code>Field</code> 对象中触发 <code>Effect Hooks</code> 都是通过 <code>notify</code>{" "}
            将事件广播
          </p>
          <p>
            <code>createEffectHook</code> 是一个高阶函数，通过第二个 <code>callback</code>{" "}
            返回可调用的函数
          </p>
        </div>
      }
