...
const CreateFormInner = forwardRef<CreateFormInnerInterface, CreateFormInnerProps>(({ tool }, ref) => {
...
const CreateForm: FC = () => {
    ...
    return <CreateFormInner ref={ref} tool={<Tool update={values => ref.current?.update(values)} />} />;
};
