...
const group = {
    ...
    "form.createObjectField().getState()": form.createObjectField({ name: "object-field" }).getState(),
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <code>IArrayFieldState</code>、<code>IObjectFieldState</code>、<code>IVoidFieldState</code> 对象
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <code>isField</code> 和 <code>isDataField</code> 返回是一样的，但 <code>isFieldState</code> 和{" "}
                        <code>isDataFieldState</code> 是不一样的
                    </li>
                </ul>
            </div>
        }
