...
const CustomIndex: FC<CustomIndexProps> = ({ footer, header }) => (
  <Wraper
    footer={
      footer || (
        <div>
          ...
          <ul>
            <li>
              <code>RecursionField</code>：递归渲染组件，在组件中代替 <code>SchemaField</code>{" "}
              解析模型 <code>schema</code>
            </li>
            <li>
    ...
    header={header || <h2>Schema 片段联动{"(自定义组件)"}</h2>}
  >
...
export interface CustomIndexProps extends WraperProps {}
