import { FormItem, Input, Password, Submit } from "@formily/antd-v5";
  ...
  >
    ...
    <Field
      ...
      reactions={field => {
        ...
        field.selfErrors =
          confirmValue && value && value !== confirmValue ? ["确认密码不匹配"] : [];
      }}
      required
    />
    <Field
      ...
      reactions={field => {
        ...
        field.selfErrors =
          passwordValue && value && value !== passwordValue ? ["确认密码不匹配"] : [];
      }}
      required
    />
  </Pannel>
