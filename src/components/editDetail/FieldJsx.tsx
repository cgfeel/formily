      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            <code>Field</code>系列组件中， 能够<code>component</code>或<code>decorator</code>
            作为子组件的内部子组件
          </li>
          <li>
            对于<code>ArrayBase</code>这种无法被<code>ArrayField</code>作为<code>component</code>{" "}
            props 包裹的组件，以及<code>Schema</code> 以外的 <code>React</code> 组件可以通过消费{" "}
