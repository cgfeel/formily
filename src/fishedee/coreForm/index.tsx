...
const CoreForm: FC = () => (
  <Panel
    footer={
      <div>
        <p>
          在演示过程中我将 <code>button</code> 也作为了 <code>Field</code>，通过自定义{" "}
          <code>effect</code> 通过 <code>form.notify</code> 实现表单联动
        </p>
        <p>
        ...
        <ul>
          <li>
            整个表单由 <code>observable</code> 更换为 <code>createForm</code> 创建的{" "}
            <code>Form</code> 对象，在 <code>Form</code> 对象中实现数据响应
          </li>
          <li>
          ...
          <li>
            这样就赋予了表单生命周期 <code>effect</code>，并且想有 <code>Field</code>{" "}
            的验证、路径查找等能力
          </li>
        </ul>
      </div>
