      ...
      <div>
        ...
        <ul>
          <li>
            ...
            ；对于这部分建议查看：React.3: 复现 <code>Field</code>、React.4: 复现{" "}
            <code>Schema</code>
            了解更透彻
          </li>
          <li>6.2: 字段名是唯一的，重复声明相同的字段名后面的会覆盖前面的字段</li>
          <li>
            6.3: 设置字段的 <code>basePath</code> 作为父级标签，尝用于 <code>RecursionField</code>{" "}
            中用于 <code>ArrayField</code>、<code>ObjectField</code> 迭代
          </li>
        </ul>
      </div>
    }
