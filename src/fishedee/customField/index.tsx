  ...
  <Panel
    footer={
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                通过 <code>useContext(FieldContext)</code> 获取父级路径，通过 <code>basePath</code>{" "}
                关联
              </li>
            </ul>
          </li>
        ...
        <ul>
          <li>
            将原来的 <code>Field</code> 改为一个基础组件 <code>ReactiveField</code>
            ，不再组件内部创建 <code>Field</code> 而是接受一个 <code>Field</code> 对象的{" "}
            <code>props</code>，允许 <code>component</code> 或 <code>decorator</code>{" "}
            没有提供的情况（设置为 <code>null</code>）
          </li>
          <li>
