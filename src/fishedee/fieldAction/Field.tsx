import { Form, createEffectHook, isField, onFieldChange, onFieldMount, onFieldValueChange } from "@formily/core";
...
const Field: FC<FieldProps> = ({ name }) => {
    ...
    useFormEffects(() => {
        ...
        onFieldChange(name, ["component"], field => Array.isArray(field.component) && setComponent(field.component[0]));
    ...
    return (
        <div className={styles}>
            字段名-{name}：<Tag color={mount ? "success" : "default"}>状态：{mount ? "已挂载" : "未挂载"}</Tag>{" "}
