...
const createSchemaField = <T extends SchemaFieldProps["components"]>(
  props: CreateSchemaFieldProps<T>,
) => {
...
> extends ISchema {
  ...
  ["x-component-props"]?: T[CNAME] extends FunctionComponent
    ? Parameters<T[CNAME]>[0]
    : Record<string, any>;
  ["x-decorator-props"]?: T[DNAME] extends FunctionComponent
    ? Parameters<T[DNAME]>[0]
    : Record<string, any>;
}
