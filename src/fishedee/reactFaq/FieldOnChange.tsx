    ...
    >
      <SchemaField>
        <SchemaField.Void
          ...
          x-component="VoidCom"
          x-component-props={{
            onChange: () => form.notify("push-tips", "void1 in children field change"),
          }}
        >
        ...
        <SchemaField.Void
          ...
          x-decorator="VoidCom"
          x-decorator-props={{
            onChange: () => form.notify("push-tips", "void2 in children field change"),
          }}
        >
        ...
        <SchemaField.Void
          ...
          x-decorator="VoidCom"
          x-decorator-props={{
            onChange: () => form.notify("push-tips", "void3 in children field change"),
          }}
        >
          <SchemaField.String
            name="input3"
      ...
      <code className="consumer">
        <pre>
          <FormConsumer>
            {({ values: { tips: _, ...data } }) => JSON.stringify(data, null, 2)}
          </FormConsumer>
        </pre>
      </code>
    </Wrapper>
