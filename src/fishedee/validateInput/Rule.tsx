import { createForm, onFormInit, registerValidateFormats, registerValidateRules } from "@formily/core";
...
const form = createForm({
    effects: () => {
        onFormInit(form => {
            ...
            form.createField({ name: "custom", validator: [{ GlobalPropertyFormat: true, required: true }] });
