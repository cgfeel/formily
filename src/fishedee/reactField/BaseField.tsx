...
const BaseField: FC = () => (
    <Wrapper
        ...
        <Field name="field" title="field" component={[Input, defaultPlaceholder]} decorator={[FormItem]} />
        <ObjectField name="object" title="object" decorator={[VoidComponent]}>
            <Field name="name" title="name" component={[Input, defaultPlaceholder]} decorator={[FormItem]} />
            <Field name="age" title="age" component={[InputDigit, defaultPlaceholder]} decorator={[FormItem]} />
        </ObjectField>
        <ArrayField name="array" title="array" decorator={[VoidComponent]}>
            <Field name="0" title="array.0" component={[Input, defaultPlaceholder]} decorator={[FormItem]} />
            <Field name="1" title="array.1" component={[Input, defaultPlaceholder]} decorator={[FormItem]} />
        </ArrayField>
        <VoidField
            description={
                <div>
                    补充：虚拟节点不仅没有 <code>value</code>，在获取子节点时，虚拟路径可以忽略，通常有两个作用：①
                    布局；② 收集 <code>schema</code>
                </div>
            }
            name="void"
            title="void"
