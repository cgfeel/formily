  ...
  return (
    <Wrapper
      footer={
        <div>
          <p>
            在 <code>formily</code>中响应的 <code>observable</code> 对象是一个 <code>proxy</code>{" "}
            对象，通过 <code>get/set</code> 收集依赖，在 <code>fish</code> 文档中单个{" "}
            <code>onFieldReact</code> 只收集一个依赖：<code>field.value = obs.name</code>
            ，当然无法相互联动，解决办法是再增加一条 <code>onFieldReact</code>
          </p>
          <p>
