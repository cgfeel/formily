        ...
        <Observer
          footer={
            <div>
              ...
              <p>
                <code>observer</code> 是一个 <code>HOC</code>，用于为 <code>react</code>{" "}
                函数组件添加 <code>reactive</code> 特性。当一个组件内部使用了{" "}
                <code>observable</code> 对象，而你希望组件响应 <code>observable</code>{" "}
                对象的变化时使用。
              </p>
              <p>
              ...
              <p>
                其实该 API 与 <code>FormConsumer</code> 的作用基本一致，只是{" "}
                <code>FormConsumer</code> 在 <code>RenderProps</code> 参数中透出了当前上下文的{" "}
                <code>form</code> 实例
              </p>
            </div>
          }
