    ...
    <Panel
        footer={
            <div>
                ...
                <p>
                    和文档不同，演示通过 <code>RecordScope</code> + <code>scope</code> 实现，避免 <code>eslint</code>{" "}
                    报错，也更方便实际使用
                </p>
                <p>
                ...
                <ul>
                    <li>
                        ...
                        ，用于传递记录作用域变量，目前已实现该约定的组件包括： <code>@formily/antd</code> 和{" "}
                        <code>@formily/next</code> 中的 <code>ArrayX</code> 系列的所有组件
                    </li>
                    <li>
                        在 <code>@formily/antd</code> 中 <code>ArrayBase</code> 的 <code>Item</code> 用到了{" "}
                        <code>RecordScope</code>，例如 <code>ArrayItems.Addition</code>、<code>ArrayItems.Remove</code>{" "}
                        通过 <code>record</code> 添加操作函数
                    </li>
                </ul>
            </div>
        }
