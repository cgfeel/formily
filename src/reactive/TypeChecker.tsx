import { action, isAnnotation, isObservable, isSupportObservable, observable, toJS } from "@formily/reactive";
    ...
    <Panel header={<h2>Type Checker</h2>}>
        ...
        <Line tips="isSupportObservable">
            <Space>
                ...
                <Button onClick={() => console.log(isSupportObservable(new B()))}>{"new B() has toJS"}</Button>
            </Space>
        </Line>
    </Panel>
);
